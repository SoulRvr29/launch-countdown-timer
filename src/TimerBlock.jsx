const TimerBlock = ({ type, value }) => {
  return (
    <div>
      <div
        id="block"
        className="relative max-md:w-[4.5rem] w-[9.375rem] max-md:h-16 h-[140px]  max-md:drop-shadow-[0_4px_0_rgba(0,0,0,0.2)] drop-shadow-[0_10px_0_rgba(0,0,0,0.2)] grid place-content-center overflow-hidden bg-Dark-desaturated-blue max-md:rounded-md rounded-lg brightness-110 z-20"
      >
